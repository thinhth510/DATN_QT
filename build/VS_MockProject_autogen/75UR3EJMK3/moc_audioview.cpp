...
struct qt_meta_stringdata_AudioView_t {
    const uint offsetsAndSize[28];
    char stringdata0[321];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AudioView_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_AudioView_t qt_meta_stringdata_AudioView = {
    {
QT_MOC_LITERAL(0, 9), // "AudioView"
...
QT_MOC_LITERAL(292, 28) // "on_pushButton_Volume_clicked"
    ...
    "AudioView\0handleDurationChanged\0\0"
...
static const uint qt_meta_data_AudioView[] = {
...
const QMetaObject AudioView::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_AudioView.offsetsAndSize,
    qt_meta_data_AudioView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AudioView_t
, QtPrivate::TypeAndForceComplete<AudioView, std::true_type>
...
void *AudioView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AudioView.stringdata0))
