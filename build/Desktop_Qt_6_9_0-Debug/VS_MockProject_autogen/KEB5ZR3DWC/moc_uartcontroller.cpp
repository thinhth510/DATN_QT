...
namespace {
struct qt_meta_tag_ZN14UARTControllerE_t {};
} // unnamed namespace

template <> constexpr inline auto UARTController::qt_create_metaobjectdata<qt_meta_tag_ZN14UARTControllerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<UARTController, qt_meta_tag_ZN14UARTControllerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject UARTController::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14UARTControllerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14UARTControllerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14UARTControllerE_t>.metaTypes,
    nullptr
} };
...
void *UARTController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14UARTControllerE_t>.strings))
